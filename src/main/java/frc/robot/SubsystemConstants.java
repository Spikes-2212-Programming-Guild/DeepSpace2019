...
public class SubsystemConstants {
	...
	public static class Lift {
		...
		public static final Supplier<Double> HATCH_FOR_SHIP_AND_LEVEL_ONE_HEIGHT
		 = ConstantHandler.addConstantDouble("hatch(sh) + hatch 1 (מצב ניטרלי)", 0);
		...
		public static final Supplier<Double> CARG_FOR_LEVEL_THREE_LATCH_UP_HEIGHT
		...
		public static final Supplier<Double> TOLERANCE
		 = ConstantHandler.addConstantDouble("lift-tolerance", 0.06);
		public static final Supplier<Double> WAIT_TIME
		 = ConstantHandler.addConstantDouble("lift-wait time", 1);
